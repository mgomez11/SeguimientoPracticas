...
<script src="https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.6.0/slick.js"></script>
    ...
    <script> 
    $(function(){
      $("#includedContent").load("encabezado.html"); 
    });
...
.slick-arrow.slick-hidden {
  ...
  <div class="container-fluid">
	...
	<p class="subtitulo">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip <p><br><br>
   <div class="col-md-4">
<div class="cont">
  <span class="cardsubtitle">Blog Post</span>
  <h3 class="cardtitle">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</h3>
   <span class="cardmeta">5 Jun 2017 | Admin</span>
   <p class="cardtext">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p> 
	<a href="#" class="thumbnail">
      <img src="data:image/svg+xml;base64,">
    </a>
</div>
  </div>
     <div class="col-md-4">
...
<div class="cont">
  ...
  <button type="button" class="btn btn-success masinfo">Mas información</button>
</div>
	</center>
